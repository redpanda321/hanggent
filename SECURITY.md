...
The following versions of Hanggent are currently being supported with security updates:
...
If you discover a security vulnerability in Hanggent, please report it responsibly:

### How to Report
- **Email**: Send details to info@hanggent.ai
