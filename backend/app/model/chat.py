...
PLATFORM_MAPPING = {
    ...
    "z-ai": "openai-compatible-model",
    "z_ai": "openai-compatible-model",
    "zai": "openai-compatible-model",
    "ModelArk": "openai-compatible-model",
    "hanggent": "openai-compatible-model",
    "Hanggent": "openai-compatible-model",
    "new-api": "openai-compatible-model",
    "new_api": "openai-compatible-model",
    "newapi": "openai-compatible-model",
    "minimax": "openai-compatible-model",
    "MiniMax": "openai-compatible-model",
    "MINIMAX": "openai-compatible-model",
    "kimi": "openai-compatible-model",
    "KIMI": "openai-compatible-model",
    "moonshot": "openai-compatible-model",
    "Moonshot": "openai-compatible-model",
    "MOONSHOT": "openai-compatible-model",
    "glm": "openai-compatible-model",
    "GLM": "openai-compatible-model",
    "chatglm": "openai-compatible-model",
    "ChatGLM": "openai-compatible-model",
    "zhipu": "openai-compatible-model",
    "Zhipu": "openai-compatible-model",
    "bigmodel": "openai-compatible-model",
    "BigModel": "openai-compatible-model",
    "google": "gemini",
    "GOOGLE": "gemini",
    "Google": "gemini",
...
class SupplementChat(BaseModel):
    ...
    attaches: list[str] = []
    # Optional model override — when the user switches model mid-conversation
    ...
    @field_validator("model_platform")
    @classmethod
    def map_model_platform(cls, v: str | None) -> str | None:
        if v is None:
            return v
        return PLATFORM_MAPPING.get(v, v)
