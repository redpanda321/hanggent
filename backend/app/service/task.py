...
class ImprovePayload(BaseModel):
    ...
    def has_model_override(self) -> bool:
        """Check if this payload includes a model override."""
        return self.model_platform is not None and self.model_type is not None

    @field_validator("model_platform", mode="before")
    @classmethod
