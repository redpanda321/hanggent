...
default_env_path = os.path.join(os.path.expanduser("~"), ".hanggent", ".env")
load_dotenv(dotenv_path=default_env_path)

# Safe base directory for user environment files
env_base_dir = os.path.join(os.path.expanduser("~"), ".hanggent")
...
def sanitize_env_path(env_path: str | None) -> str | None:
    ...
    Security: Ensures the path stays within ~/.hanggent directory
    and ends with .env
