...
# ========= Copyright 2025-2026 @ Hanggent.AI All Rights Reserved. =========
"""
Centralized router registration for the Hanggent API.
...
def register_routers(app: FastAPI, prefix: str = "") -> None:
    ...
    routers_config = [
        ...
        {
            "router": opencode_controller.router,
            "tags": ["OpenCode"],
            "description": "Proxy endpoints for OpenCode developer agent service",
        },
        {
            "router": openclaw_controller.router,
            "tags": ["OpenClaw"],
            "description": "Proxy endpoints for OpenClaw messaging gateway",
        },
    ]
