...
DEFAULT_LANGFUSE_TAGS = ["workforce", "camel", "hanggent"]
LANGFUSE_OTEL_PATH = "/api/public/otel"

# Attribute keys for hanggent.project namespace
ATTR_PROJECT_ID = "hanggent.project.id"

# Attribute keys for hanggent.task namespace
ATTR_TASK_ID = "hanggent.task.id"
ATTR_TASK_DESCRIPTION = "hanggent.task.description"
ATTR_TASK_PARENT_ID = "hanggent.task.parent_id"
ATTR_TASK_TYPE = "hanggent.task.type"
ATTR_TASK_STATUS = "hanggent.task.status"
ATTR_TASK_UPDATE_TYPE = "hanggent.task.update_type"
ATTR_TASK_UPDATE_OLD_VALUE = "hanggent.task.update.old_value"
ATTR_TASK_UPDATE_NEW_VALUE = "hanggent.task.update.new_value"
ATTR_TASK_UPDATE_METADATA = "hanggent.task.update.metadata"
ATTR_TASK_QUEUE_TIME_SECONDS = "hanggent.task.queue_time_seconds"
ATTR_TASK_PROCESSING_TIME_SECONDS = "hanggent.task.processing_time_seconds"
ATTR_TASK_QUALITY_SCORE = "hanggent.task.quality_score"
ATTR_TASK_TIMESTAMP = "hanggent.task.timestamp"
ATTR_TASK_DEPENDENCIES = "hanggent.task.dependencies"
ATTR_TASK_SUBTASK_IDS = "hanggent.task.subtask_ids"

# Attribute keys for hanggent.worker namespace
ATTR_WORKER_ID = "hanggent.worker.id"
ATTR_WORKER_TYPE = "hanggent.worker.type"
ATTR_WORKER_ROLE = "hanggent.worker.role"
ATTR_WORKER_AGENT = "hanggent.worker.agent"
ATTR_WORKER_MODEL_TYPE = "hanggent.worker.model.type"
...
SERVICE_NAME_WORKFORCE = "hanggent-workforce"
TRACER_NAME_WORKFORCE = "hanggent.workforce"
        ...
        if event.task_id in self.task_spans:
            ...
            if event.token_usage:
                ...
                for key, value in event.token_usage.items():
                    span.set_attribute(f"hanggent.task.token_usage.{key}", value)
