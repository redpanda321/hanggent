...
class Workforce(BaseWorkforce):
    ...
    def hanggent_make_sub_tasks(
        ...
        """Split process_task method to hanggent_make_sub_tasks
        and hanggent_start method.
        ...
        """
        logger.debug(
            "[DECOMPOSE] hanggent_make_sub_tasks called",
    ...
    async def hanggent_start(self, subtasks: list[Task]):
        """start the workforce"""
        logger.debug(
            (
                f"[WF-LIFECYCLE] hanggent_start called with "
    ...
    def add_single_agent_worker(
        ...
        if on_stream_text:
            worker_node.on_stream_text = on_stream_text
