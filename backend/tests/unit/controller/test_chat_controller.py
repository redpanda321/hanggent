...
@pytest.mark.unit
class TestChatControllerUrlNormalization:
    def test_normalize_runtime_api_url_anthropic_exact_domain(self):
        assert (
            normalize_runtime_api_url("anthropic", "https://api.anthropic.com")
            == "https://api.anthropic.com/v1"
        )

    def test_normalize_runtime_api_url_anthropic_existing_path_unchanged(self):
        assert (
            normalize_runtime_api_url(
    ...
    def test_normalize_runtime_api_url_non_anthropic_unchanged(self):
        assert (
            normalize_runtime_api_url("openai", "https://api.openai.com/v1")
            == "https://api.openai.com/v1"
        )

    def test_normalize_runtime_api_url_none_passthrough(self):
        assert normalize_runtime_api_url("anthropic", None) is None
