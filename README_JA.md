...
<div align="right">
<a href="https://www.hangent.com/download">Hanggent.aiで始める →</a>
</div>
...
Hanggentは[CAMEL-AI.org][camel-ai-org-github]の研究とインフラストラクチャの上に構築されています。[CAMEL-AI.orgをスポンサー][sponsor-link]することで`Hanggent`がより良くなります。
