...
description: Configure your own API keys to use various LLM providers with Hanggent.
---

## What is BYOK?

**Bring Your Own Key (BYOK)** allows you to use your own API keys from various AI model providers with Hanggent. Instead of relying on a shared service, you connect directly to providers like OpenAI, Anthropic, or Google using your personal API credentials. This gives you:
...
### Step 2: Configure in Hanggent

1. Launch Hanggent and go to **Settings** > **Models**
...
When saving your configuration, Hanggent validates your API key and model. Here are the errors you may encounter:
...
Hanggent supports the following BYOK providers:
...
| **Qwen (Alibaba)**    | Intl: `https://dashscope-intl.aliyuncs.com/compatible-mode/v1`<br/>China: `https://dashscope.aliyuncs.com/compatible-mode/v1` | [Qwen API Docs](https://help.aliyun.com/zh/dashscope/developer-reference/api-details)         |
